...
def upgrade() -> None:
    ...
    op.create_index(op.f("ix_ai_systems_id"), "ai_systems", ["id"], unique=False, if_not_exists=True)
    ...
    op.create_index(
        op.f("ix_risk_assessments_id"), "risk_assessments", ["id"], unique=False, if_not_exists=True
    )
    ...
    op.create_index(
        op.f("ix_document_versions_id"), "document_versions", ["id"], unique=False, if_not_exists=True
    )
    ...
    op.create_index(
        op.f("ix_guard_scan_logs_id"), "guard_scan_logs", ["id"], unique=False, if_not_exists=True
    )
    op.create_index(
    ...
    op.create_index(op.f("ix_rag_queries_id"), "rag_queries", ["id"], unique=False, if_not_exists=True)
    ...
    op.create_index(
        op.f("ix_notifications_id"), "notifications", ["id"], unique=False, if_not_exists=True
    )
